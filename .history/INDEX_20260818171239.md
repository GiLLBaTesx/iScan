...
- **Sections = Optional Class Groups:** Sections within subjects for class organization (Grade 7-A, 7-B)
- **No Redundant Metadata:** Exams don't need to repeat subject/section info - folders provide the organization
- **Simplified Exam Creation:** Just exam name + number of questions - folder context provides the rest
...
3. **Exams** - `id, subjectFolderId, sectionId, name, totalQuestions, gradingScale, passingGrade, examDate, createdAt, isDeleted`
...
**Database Version:** 5 (removed redundant subject/section fields from exams)  
**Navigation:** Folder-based (2-3 taps per action)  
**Features:** 100% Complete including Simplified Exam Creation
