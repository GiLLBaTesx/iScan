...
**Worker for Long-Running Tasks:**
```kotlin
class SyncWorker(context: Context, params: WorkerParameters) : CoroutineWorker(context, params) {
    override suspend fun doWork(): Result {
        return try {
            val syncManager = (applicationContext as ExamScannerApplication).syncManager
            syncManager.performSync(getUserId())
            Result.success()
        } catch (e: Exception) {
...
android {
    ...
    defaultConfig {
        applicationId "com.offlineassessment.premium"  // NEW app ID
        minSdk 26
        targetSdk 34
        versionCode 2  // Increment from v1
        versionName "2.0"
    }
...
dependencies {
    // EXISTING DEPENDENCIES (keep all from v1)
    ...
    // Room Database (keep existing)
    implementation 'androidx.room:room-runtime:2.6.1'
    implementation 'androidx.room:room-ktx:2.6.1'
    kapt 'androidx.room:room-compiler:2.6.1'
    
    // CameraX (keep existing)
    implementation 'androidx.camera:camera-camera2:1.3.1'
    implementation 'androidx.camera:camera-lifecycle:1.3.1'
    implementation 'androidx.camera:camera-view:1.3.1'
    
    // ML Kit (keep existing)
    implementation 'com.google.mlkit:text-recognition:16.0.0'
    
    // NEW: ML Kit Barcode Scanning for QR codes
    implementation 'com.google.mlkit:barcode-scanning:17.2.0'
    
    // NEW: ZXing for QR code generation
    implementation 'com.google.zxing:core:3.5.2'
    implementation 'com.google.zxing:android-core:3.3.0'
    
    // NEW: iText7 for PDF generation
    implementation 'com.itextpdf:itext7-core:7.2.5'
    implementation 'com.itextpdf:layout:7.2.5'
    
    // NEW: Apache POI for Excel import/export
    implementation 'org.apache.poi:poi:5.2.5'
    implementation 'org.apache.poi:poi-ooxml:5.2.5'
    
    // NEW: Firebase for cloud sync (optional)
    implementation platform('com.google.firebase:firebase-bom:32.7.0')
    implementation 'com.google.firebase:firebase-auth-ktx'
    implementation 'com.google.firebase:firebase-firestore-ktx'
    implementation 'com.google.firebase:firebase-storage-ktx'
    
    // NEW: Google Play Billing for subscriptions
    implementation 'com.android.billingclient:billing-ktx:6.1.0'
    
    // NEW: WorkManager for background sync
    implementation 'androidx.work:work-runtime-ktx:2.9.0'
    
    // NEW: Kotlinx Serialization for JSON
    implementation 'org.jetbrains.kotlinx:kotlinx-serialization-json:1.6.2'
    
    // NEW: Accompanist System UI Controller
    implementation 'com.google.accompanist:accompanist-systemuicontroller:0.32.0'
    
    // NEW: Charts library for analytics visualization
    implementation 'com.github.PhilJay:MPAndroidChart:v3.1.0'
    
    // NEW: SQLCipher for database encryption
...
buildscript {
    dependencies {
        classpath 'com.google.gms:google-services:4.4.0'  // NEW: Firebase
    }
}
...
plugins {
    ...
    id 'org.jetbrains.kotlin.plugin.serialization' version '1.9.20' apply false  // NEW
}
```
...
- Database migration validation from v1 to v2
...
- Validate cloud sync reliability
...
**Goal: Database expansion and core infrastructure**

Tasks:
1. Create database migration from v1 to v2
2. Implement all new entities (Subject, Section, MELC, etc.)
3. Set up MELCs database loading from JSON asset
4. Create base repositories for new entities
5. Write migration tests
6. Test backward compatibility with v1 data

Deliverables:
- Working database migration
- All DAOs implemented
- MELCs database populated (5,000+ records)
- Migration tested on real v1 data

#### Phase 2: Subject & Section Management (Weeks 3-4)
**Goal: Three-tier organizational hierarchy**

Tasks:
1. Implement SubjectRepository and ViewModel
2. Create Subject List Screen with CRUD operations
3. Implement SectionRepository and ViewModel
4. Create Section Management Screen
5. Implement student enrollment logic
6. Build roster import/export (CSV)
7. Update navigation hierarchy
...
#### Phase 8: Cloud Sync (Weeks 15-16)
**Goal: Optional Firebase backup**

Tasks:
1. Set up Firebase project
2. Implement Firebase Authentication
3. Build SyncManager service
4. Implement bidirectional sync logic
5. Add conflict resolution (last-write-wins)
6. Implement AES-256 encryption for sensitive data
7. Create sync settings screen
8. Test sync across multiple devices
9. Handle offline queue and retry logic
...
class SecureCloudSync {
    ...
    /**
     * Encrypts sensitive data before Firebase upload
...
- No personal data sent to third parties (except optional Firebase)
- Clear consent flow for cloud sync
...
class PrivacyManager(private val repository: ExamRepository) {
    ...
    suspend fun deleteAllStudentData(studentId: Long) {
        ...
        if (isSyncEnabled()) {
            syncManager.deleteRemoteData("students", studentId)
        }
    }
...
| **Cloud Sync Conflicts** | Medium | Medium | - Last-write-wins strategy with timestamps<br>- Conflict logs for debugging<br>- Manual conflict resolution UI (future) |
...
| Risk | Probability | Impact | Mitigation Strategy |
|------|-------------|--------|---------------------|
| **Firebase Cost Overruns** | Low | Medium | - Monitor usage dashboards<br>- Implement rate limiting<br>- Optimize sync frequency<br>- Alert at 80% budget threshold |
...
| **Data Loss** | Low | Critical | - Automatic local backups<br>- Cloud sync redundancy<br>- Export functionality<br>- Database corruption recovery |
...
```
app/src/main/java/com/offlineassessment/premium/
├── MainActivity.kt
