...
fun ExamScannerApp() {
    ...
    NavHost(navController = navController, startDestination = "subject_folders") {
        ...
        composable(
            ...
            // Debug logging
            android.util.Log.e("MainActivity", "🔥🔥🔥 EditKey: allMelcs.size = ${allMelcs.size}")
            ...
            EditKeyScreen(
                ...
                availableMelcs = allMelcs.also { 
                    android.util.Log.e("MainActivity", "🔥🔥🔥 Passing ${it.size} MELCs to EditKeyScreen") 
                },
