    ...
    Column(
        ...
        if (filteredExams.isEmpty()) {
            ...
            androidx.compose.foundation.lazy.LazyColumn(
                ...
                items(count = filteredExams.size) { index ->
...
fun StatsTab(viewModel: ExamViewModel) {
    ...
    val overallAverage = examState.exams.mapNotNull { it.averageScore?.toDouble() }.average().takeIf { !it.isNaN() } ?: 0.0
    ...
    Column(
        ...
        Row(
            ...
            StatCard(
                modifier = Modifier.weight(1f),
                value = overallAverage.let { String.format("%.1f%%", it) },
                label = "Average",
