...
object SmartReportPDFGenerator {
    ...
    private fun drawItemAnalysisRow(canvas: android.graphics.Canvas, item: ItemAnalysisData, startY: Int): Int {
        ...
        // Level (colored)
        paint.color = when (item.difficulty) {
            DifficultyLevel.EASY -> android.graphics.Color.parseColor("#34C759")
            DifficultyLevel.MODERATE -> android.graphics.Color.parseColor("#FF9500")
            DifficultyLevel.DIFFICULT -> android.graphics.Color.parseColor("#FF3B30")
        }
        canvas.drawText(
