...
### No Folders Required!
**Just create exams and optionally tag them:**
- Create exams directly from home screen
- Add subject tag (optional): "Math", "Science", "English", "Filipino"
- Add section tag (optional): "7-A", "7-B", "Morning Class"
- Filter by subject or section when you need to
- No mandatory folder hierarchy to navigate
...
→ Section: 7-A (optional)
→ CREATE → Done!
```

All exams show on home screen. Use filters when needed.
